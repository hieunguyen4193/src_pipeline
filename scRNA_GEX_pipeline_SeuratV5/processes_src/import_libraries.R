...
print(sprintf("Install the following new packages from CRAN: %s", paste(new.packages, collapse = ", ")))
print(sprintf("Install the following new packages from BioConductor: %s", paste(new.bioc.packages, collapse = ", ")))
